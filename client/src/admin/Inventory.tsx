...
import { removeProduct, setPageNumber } from "../Features/catalog/catalogSlice";
...
export default function Inventory() {
    ...
    const hadleSelectProduct = (product: Products)=> {
                        ...
                        {products.map((product) => (
                            ...
                            >
                                ...
                                <TableCell align="right">
                                    <Button onClick={()=>  hadleSelectProduct(product)} startIcon={<Edit />} />
                                    <LoadingButton 
